...
public class CinemaResponseStats {
    private int current_income;
    private int number_of_available_seats;
    private int number_of_purchased_tickets;

    public CinemaResponseStats() {
    }

    public CinemaResponseStats(int current_income, int number_of_available_seats, int number_of_purchased_tickets) {
